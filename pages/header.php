...
<head>
    ...
    <meta name="description"
        content="Маркировка по честному знаку. Печать цветных этикеток с кодом DataMatrix. Услуги по маркировке молочной продукции, одежды и других товаров попадающих под обязательную маркировку.">
    <meta name="Keywords"
        content="честный знак, маркировка, этикетка, печать этикеток, принтер этикеток, маркировка молочной продукции">
